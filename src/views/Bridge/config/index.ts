...
const getToNetwork = (fromKey: number) => {
  const to: any = {}
...
const config: any = {
  main: {
    NETWORK_URL: 'https://mainnet.infura.io/v3/798f728850664ccdba2f40009460b5b9',
    BRIDGE_TOKEN_LIST: [
      {
